...
const std::string MODEL_PATH = "models/chalet/chalet.obj";
const std::string TEXTURE_PATH = "models/chalet/chalet.jpg";
...
struct QueueFamilyIndices {
    ...
    bool isComplete() {
        return (graphicsFamily.value()!=-1) && (presentFamily.value()!=-1);
    }
};
